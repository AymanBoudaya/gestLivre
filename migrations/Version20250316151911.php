 ...
 */
final class Version20250316151911 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE livre ADD editeur_id INT DEFAULT NULL, ADD categorie_id INT DEFAULT NULL');
